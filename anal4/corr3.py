...
def setScatterGraph(tour_table, all_table, tourPoint):
    ...
    # 계산에 필요한 자료만 뽑아 별도 저장하고 외국인 관광 자료와 병합
...
def chulbal():
    ...
    fname= 'anal4/서울특별시_관광지입장정보_2011_2016.json'
    ...
    cdf = 'anal4/중국인방문객.json'
    jdata = json.loads(open(cdf, 'r', encoding='utf8').read())
