...
# 가설
# 귀무 가설: 기대치와 관찰치는 차이가 없다. (주사위는 게임에 적합하다)
# 대립 가설: 기대치와 관찰치는 차이가 있다. (주사위는 게임에 적합하지 않다)
...
# 카이제곱: 14.20, p-value : 0.01438
# 결론 : p-value(0.01438) < 유의수준(0.05) 귀무 기각.
# 주사위는 게임에 적합하지 않다.
...
# Power_divergenceResult(statistic=np.float64(14.200000000000001), pvalue=np.float64(0.014387678176921308))
# 결과 : p-value(0.00039) < 유의수준(0.05) 귀무 기각. 선호도에 차이가 있다.
