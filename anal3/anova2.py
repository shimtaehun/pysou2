...
gr2 = data[data[:, 1]==2, 0]
gr3 = data[data[:, 1]==3, 0]
print(gr1, '', np.mean(gr1))    # 316.62
print(gr2, '', np.mean(gr2))    # 256.44
print(gr3, '', np.mean(gr3))    # 278.00
# 정규성
...
print('f_statistic: ', f_statistic) # 3.711335
print('p_value: ', p_value)     # 0.0435893 < 0.05  귀무기각
