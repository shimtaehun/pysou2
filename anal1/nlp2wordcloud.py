# pip install pygame pip install pytagcloud pip install simplejson
# 동아일보 검색 기능으로 문자열을 읽어 형태소 분석 후 원드클라우드로 출력
...
# print(taglist)  # {'color': (176, 105, 124), 'size': 58, 'tag': '포스터'}
